...
void sendDataToOpenGL()
{
    ...
    generateInstancedArray(amount_pie, 21, 240, 3);
    generateInstancedArray(amount_tomato, 20, 280, 3);
...
void paintGL(void)  //always run
{
    ...
    glm::vec3 lightPosition1(10.0f, 10.0f, -20.0f);
    glm::vec3 lightPosition2(-10.0f, 10.0f, -20.0f);
    ...
    glm::mat4 alienPeoplePretranslate = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 6.0f, 0.0f));
    
    //chicken parameter
    glm::mat4 chickenPrescaleMatrix = glm::scale(glm::mat4(1.0f),glm::vec3(0.004f,0.004f,0.004f));
    ...
    for (int k = 0; k <= 3; k++)
    {
        ...
        modelTransformMatrix = glm::mat4(1.0f);
        modelTransformMatrix = alienTranslateMatrix * alienPeoplePrescaleMatrix * selfRotate * alienPeoplePretranslate *  modelTransformMatrix;
        glUniformMatrix4fv(modelTransformMatrixUniformLocation, 1, GL_FALSE, &modelTransformMatrix[0][0]);
        glActiveTexture(GL_TEXTURE0);
